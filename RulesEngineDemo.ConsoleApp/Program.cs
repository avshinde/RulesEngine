...
namespace PTC.RulesEngine.ConsoleApp
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            Console.WriteLine("Type 'reload' to reload rules, 'exit' to quit, or press Enter to execute rules.");
            ...
            while (true)
            {
                ...
                Console.WriteLine("\nType 'reload' to reload rules, 'exit' to quit, or press Enter to execute again.");
